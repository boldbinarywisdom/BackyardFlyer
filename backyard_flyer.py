...
# Here is the output you should see for succesfull run on the output window
...
# The box as a perimeter. The same can be verified in the output

    def calculate_box(self):
        print("Setting Home")
	#print("Local waypoints defined in 3D space")
...
# individual transitions
    ...
    def start(self):
        ...
        print("starting drone -- Backyard Flyer")
        # self.connect()
...
#If the script is called standalone
